...
public class ControllerEndpointAspect extends BaseAspectSupport {
  ...
  @Pointcut("execution(* com.yunke.core.module.system.controller.*.*(..)) && @annotation(com.yunke.core.annotation.ControllerEndpoint)")
