...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'OAuth2 认证授权客户端表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'OAuth2认证授权授权码表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_certificate`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '考证ID',
  `user_id` int(11) NOT NULL COMMENT '考证人ID',
  `type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '类型',
  `title` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '证书名称',
  `cost` double(10, 2) NULL DEFAULT NULL COMMENT '费用',
  `time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '考证时间',
  ...
  `success` int(11) NULL DEFAULT NULL COMMENT '通过状态(0:失败/1:成功)',
  `reimbursement` int(11) NULL DEFAULT NULL COMMENT '是否已报销（0否/1是）',
  `state` int(11) NOT NULL COMMENT '状态（0正在考取/1已完成）',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `考证人`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '资格证表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_copyright`  (
  ...
  `certificate` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '证书',
  `application_form` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '申请书',
  `origin_file` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '源文件',
  `agreement` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '软件协议',
  `cost` double(10, 2) NULL DEFAULT NULL COMMENT '费用',
  `invoice` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '发票',
  `item_id` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '项目ID',
  `state` int(11) NULL DEFAULT NULL COMMENT '状态(1:进行中/2:已完成/3:申报中)',
  `reimbursement` int(11) NULL DEFAULT NULL COMMENT '是否已报销（0否/1是）',
  PRIMARY KEY (`copyright_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '软件著作权_任务表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '部门表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_funding`  (
  ...
  `certifier_id` int(11) NULL DEFAULT NULL COMMENT '证明人ID',
  ...
  `apply_time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '申请时间',
  `success_time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '报销成功时间',
  `invoice` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '发票',
  `cost` double(10, 2) NULL DEFAULT NULL COMMENT '费用',
  `card` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '银行卡号',
  `proposer_id` int(11) NOT NULL COMMENT '申请人的ID',
  `state` int(11) NULL DEFAULT NULL COMMENT '申请状态(1申请中/2报销中/3报销成功/4申请失败)',
  `task_id` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '对应的任务编号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `经手人`(`verifier_id`) USING BTREE,
  INDEX `proverUUID`(`certifier_id`) USING BTREE,
  INDEX `proposer_id`(`proposer_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '经费表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_items`  (
  ...
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '标题',
  `introduction` varchar(1500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '简介',
  `start_time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '结束时间',
  `cost` double(10, 2) NULL DEFAULT NULL COMMENT '费用',
  `invoice` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '发票',
  `specification` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '项目说明书',
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '源文件',
  `state` int(11) NULL DEFAULT NULL COMMENT '状态(1:进行中/2:已完成)',
  `reimbursement` int(11) NULL DEFAULT NULL COMMENT '是否已报销（0否/1是）',
  PRIMARY KEY (`items_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '项目_任务表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = MyISAM AUTO_INCREMENT = 153 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户操作日志表' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_log` VALUES (138, '201704044', '新增菜单', 99, 'com.yunke.core.module.system.controller.MenuController.addMenu()', ' menu: \"Menu(menuId=214, parentId=0, menuName=云存储服务, path=/oss, component=Layout, perms=, icon=el-icon-cloudy, type=0, orderNum=4, createTime=Wed Jul 08 21:04:39 CST 2020, updateTime=null)\"', '127.0.0.1', '2020-07-08 21:04:39', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (139, '201704044', '新增菜单', 23, 'com.yunke.core.module.system.controller.MenuController.addMenu()', ' menu: \"Menu(menuId=215, parentId=0, menuName=七牛云, path=null, component=null, perms=oss:view, icon=null, type=1, orderNum=null, createTime=Wed Jul 08 21:05:30 CST 2020, updateTime=null)\"', '127.0.0.1', '2020-07-08 21:05:31', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (140, '201704044', '更新角色', 198, 'com.yunke.core.module.system.controller.RoleController.updateRole()', ' role: \"Role(roleId=1, roleName=null, remark=管理员, createTime=null, updateTime=Wed Jul 08 21:05:42 CST 2020, menuIds=1,3,135,130,11,12,13,4,131,14,15,16,5,132,19,17,18,6,133,22,21,20,163,167,166,165,164,2,180,10,136,24,150,152,151,212,213,214,154,155,168,169,170,171,172)\"', '127.0.0.1', '2020-07-08 21:05:43', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (141, '201704044', '删除角色', 77, 'com.yunke.core.module.system.controller.MenuController.deleteMenus()', ' menuIds: \"215\"', '127.0.0.1', '2020-07-08 21:06:10', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (142, '201704044', '新增菜单', 27, 'com.yunke.core.module.system.controller.MenuController.addMenu()', ' menu: \"Menu(menuId=216, parentId=214, menuName=七牛云, path=null, component=null, perms=oss:view, icon=null, type=1, orderNum=null, createTime=Wed Jul 08 21:06:26 CST 2020, updateTime=null)\"', '127.0.0.1', '2020-07-08 21:06:27', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (143, '201704044', '更新角色', 203, 'com.yunke.core.module.system.controller.RoleController.updateRole()', ' role: \"Role(roleId=1, roleName=null, remark=管理员, createTime=null, updateTime=Wed Jul 08 21:06:36 CST 2020, menuIds=1,3,135,130,11,12,13,4,131,14,15,16,5,132,19,17,18,6,133,22,21,20,163,167,166,165,164,2,180,10,136,24,150,152,151,212,213,214,216,154,155,168,169,170,171,172)\"', '127.0.0.1', '2020-07-08 21:06:36', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (144, '201704044', '更新角色', 245, 'com.yunke.core.module.system.controller.RoleController.updateRole()', ' role: \"Role(roleId=1, roleName=null, remark=管理员, createTime=null, updateTime=Wed Jul 08 21:09:49 CST 2020, menuIds=1,3,130,135,11,12,13,4,131,14,15,16,5,132,17,18,19,6,22,133,20,21,163,164,165,166,167,2,180,10,24,136,150,152,151,212,213,214,215,216,217,218,154,155,168,169,170,171,172)\"', '127.0.0.1', '2020-07-08 21:09:50', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (145, '201704044', '更新角色', 260, 'com.yunke.core.module.system.controller.RoleController.updateRole()', ' role: \"Role(roleId=1, roleName=null, remark=管理员, createTime=null, updateTime=Wed Jul 08 21:11:33 CST 2020, menuIds=1,3,135,130,13,12,11,4,131,16,15,14,5,132,19,18,17,6,20,133,22,21,163,164,165,166,167,2,180,10,136,24,150,152,151,212,213,214,215,216,217,218,219,154,155,168,169,170,171,172)\"', '127.0.0.1', '2020-07-08 21:11:34', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (146, '201704044', '新增菜单', 1208, 'com.yunke.core.module.system.controller.MenuController.addMenu()', ' menu: \"Menu(menuId=220, parentId=0, menuName=任务管理, path=/studio/thesis, component=, perms=task:view, icon=, type=0, orderNum=0, createTime=Thu Jul 16 15:16:42 CST 2020, updateTime=null)\"', '169.254.163.162', '2020-07-16 15:16:43', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (147, '201704044', '新增菜单', 1177, 'com.yunke.core.module.system.controller.MenuController.addMenu()', ' menu: \"Menu(menuId=221, parentId=220, menuName=新增任务, path=null, component=null, perms=task:add, icon=null, type=1, orderNum=null, createTime=Thu Jul 16 15:17:10 CST 2020, updateTime=null)\"', '169.254.163.162', '2020-07-16 15:17:11', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (148, '201704044', '新增菜单', 1162, 'com.yunke.core.module.system.controller.MenuController.addMenu()', ' menu: \"Menu(menuId=222, parentId=220, menuName=修改任务, path=null, component=null, perms=task:update, icon=null, type=1, orderNum=null, createTime=Thu Jul 16 15:17:32 CST 2020, updateTime=null)\"', '169.254.163.162', '2020-07-16 15:17:33', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (149, '201704044', '新增菜单', 1180, 'com.yunke.core.module.system.controller.MenuController.addMenu()', ' menu: \"Menu(menuId=223, parentId=220, menuName=删除任务, path=null, component=null, perms=task:delete, icon=null, type=1, orderNum=null, createTime=Thu Jul 16 15:17:48 CST 2020, updateTime=null)\"', '169.254.163.162', '2020-07-16 15:17:49', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (150, '201704044', '新增菜单', 1161, 'com.yunke.core.module.system.controller.MenuController.addMenu()', ' menu: \"Menu(menuId=224, parentId=220, menuName=修改负责人, path=null, component=null, perms=task:charge, icon=null, type=1, orderNum=null, createTime=Thu Jul 16 15:18:06 CST 2020, updateTime=null)\"', '169.254.163.162', '2020-07-16 15:18:08', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (151, '201704044', '新增角色', 1127, 'com.yunke.core.module.system.controller.RoleController.addRole()', ' role: \"Role(roleId=8, roleName=任务负责人, remark=可对任务和成员进行修改, createTime=Thu Jul 16 15:20:16 CST 2020, updateTime=null, menuIds=220,222)\"', '169.254.163.162', '2020-07-16 15:20:18', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (152, '201704044', '更新角色', 1203, 'com.yunke.core.module.system.controller.RoleController.updateRole()', ' role: \"Role(roleId=1, roleName=null, remark=管理员, createTime=null, updateTime=Thu Jul 16 15:20:48 CST 2020, menuIds=220,221,222,223,224,1,3,11,12,13,130,135,4,14,15,16,131,5,17,18,19,132,6,20,21,22,133,163,164,165,166,167,2,180,10,24,136,150,151,152,212,213,214,219,215,216,217,218,154,155,168,169,170,171,172)\"', '169.254.163.162', '2020-07-16 15:20:50', '内网IP|0|0|内网IP|内网IP');
...
) ENGINE = MyISAM AUTO_INCREMENT = 78 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '登录日志表' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_login_log` VALUES (76, '201704044', '2020-07-08 21:01:29', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
INSERT INTO `t_login_log` VALUES (77, '201704044', '2020-07-08 21:06:56', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'OSX', 'MSEdge');
...
CREATE TABLE `t_match`  (
  ...
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '比赛名称',
  `level` int(11) NULL DEFAULT NULL COMMENT '比赛等级(0:国家级/1:省级/2:校级)',
  `type` int(11) NULL DEFAULT NULL COMMENT '比赛类型（0:个人/1:团队）',
  `application_form` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '申请书',
  `time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '比赛时间',
  `cost` double(10, 2) NULL DEFAULT NULL COMMENT '费用',
  `invoice` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '发票',
  `certificate` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '证书',
  `state` int(11) NULL DEFAULT NULL COMMENT '状态(1:进行中/2:已结束)',
  `reimbursement` int(11) NULL DEFAULT NULL COMMENT '是否已报销（0否/1是）',
  PRIMARY KEY (`match_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '比赛_任务表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_match_member_awards`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `user_id` int(11) NULL DEFAULT NULL COMMENT '用户id(为空是团队赛，团队奖)',
  `rank_code` int(11) NULL DEFAULT NULL COMMENT '奖项(1：一等，2：二等，3：三等，4：特等，5：优胜，6、无)',
  `task_id` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '关联 比赛UUID',
  `certificate` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '奖状',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `userUUID`(`user_id`) USING BTREE,
  INDEX `taskUUID`(`task_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '比赛人员奖项表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_members`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '标识字段',
  `user_id` int(11) NOT NULL COMMENT '成员ID',
  `task_id` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '任务ID',
  `state` int(11) NOT NULL COMMENT '1为负责人，2为成员，3为指导老师',
  PRIMARY KEY (`id`, `user_id`, `task_id`) USING BTREE,
  INDEX `taskUUID`(`task_id`) USING BTREE,
  INDEX `id`(`id`) USING BTREE,
  INDEX `task_user`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '任务成员的中间表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_menu`  (
  ...
  `perms` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '权限表达式',
...
) ENGINE = InnoDB AUTO_INCREMENT = 225 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单表' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_menu` VALUES (214, 0, '云存储服务', '/oss', 'Layout', '', 'el-icon-cloudy', '0', 4, '2020-07-08 21:04:39', NULL);
INSERT INTO `t_menu` VALUES (215, 219, '配置管理', NULL, NULL, 'qiniu:config', NULL, '1', NULL, '2020-06-27 16:08:38', '2020-06-27 16:10:00');
INSERT INTO `t_menu` VALUES (216, 219, '删除文件', NULL, NULL, 'qiniu:delete', NULL, '1', NULL, '2020-06-27 16:08:51', '2020-06-27 16:09:40');
INSERT INTO `t_menu` VALUES (217, 219, '上传文件', NULL, NULL, 'qiniu:upload', NULL, '1', NULL, '2020-06-27 16:09:08', '2020-06-27 16:09:47');
INSERT INTO `t_menu` VALUES (218, 219, '同步文件', NULL, NULL, 'qiniu:synchronized', NULL, '1', NULL, '2020-06-27 16:09:30', '2020-06-27 16:09:53');
INSERT INTO `t_menu` VALUES (219, 214, '七牛云', '/oss/qiniu', 'yunke/oss/qiniu/Index', 'qiniu:view', NULL, '0', 1, '2020-06-26 18:52:47', '2020-06-26 20:55:30');
INSERT INTO `t_menu` VALUES (220, 0, '任务管理', '/studio/thesis', '', 'task:view', '', '0', 0, '2020-07-16 15:16:42', NULL);
INSERT INTO `t_menu` VALUES (221, 220, '新增任务', NULL, NULL, 'task:add', NULL, '1', NULL, '2020-07-16 15:17:10', NULL);
INSERT INTO `t_menu` VALUES (222, 220, '修改任务', NULL, NULL, 'task:update', NULL, '1', NULL, '2020-07-16 15:17:32', NULL);
INSERT INTO `t_menu` VALUES (223, 220, '删除任务', NULL, NULL, 'task:delete', NULL, '1', NULL, '2020-07-16 15:17:48', NULL);
INSERT INTO `t_menu` VALUES (224, 220, '修改负责人', NULL, NULL, 'task:charge', NULL, '1', NULL, '2020-07-16 15:18:06', NULL);
...
CREATE TABLE `t_note`  (
  `note_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '备注主键',
  `note_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注类型',
...
CREATE TABLE `t_orientation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '方向表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_postgraduate`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '考研ID',
  `user_id` int(11) NOT NULL COMMENT '考研人ID',
  `time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '报考时间',
  `school` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '报考学校',
  `orientation` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '报考方向',
  `exam` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '统考成绩',
  `state` int(11) NOT NULL COMMENT '状态（0:正在考取/1:已完成）',
  `success` int(11) NULL DEFAULT NULL COMMENT '通过状态(0:失败/1:成功)',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `考研人`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '考研人员表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Records of t_qiniu_config
-- ----------------------------
INSERT INTO `t_qiniu_config` VALUES (1, 'CV6IfAmvnOgRSn0u-P8B3BQvaDM0WktIXvHOIP-a', 'yunke-oss', 'http://yunke-oss.chachae.cn', '6P-poY1suJvQvsJQK7CIUNZixo9LJQKDP2LW7Aon', '公开', '华东');
...
CREATE TABLE `t_qiniu_content`  (
  ...
  `bucket` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Bucket 识别符',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文件名称',
  `size` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文件大小',
  `type` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文件类型：私有或公开',
  `url` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文件url',
  `suffix` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文件后缀',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '上传或同步的时间',
  PRIMARY KEY (`content_id`) USING BTREE,
  UNIQUE INDEX `uniq_name`(`name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 250 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '七牛云文件存储' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of t_qiniu_content
-- ----------------------------
INSERT INTO `t_qiniu_content` VALUES (245, 'yunke-oss', 'jmeter_square', '6.46KB   ', '公开', 'http://yunke-oss.chachae.cn/jmeter_square.png', 'png', '2020-07-08 22:25:55');
INSERT INTO `t_qiniu_content` VALUES (246, 'yunke-oss', 'apply_naming_policy2', '8.66KB   ', '公开', 'http://yunke-oss.chachae.cn/apply_naming_policy2.png', 'png', '2020-07-08 22:26:24');
INSERT INTO `t_qiniu_content` VALUES (247, 'yunke-oss', 'apply_naming_policy1', '13.12KB   ', '公开', 'http://yunke-oss.chachae.cn/apply_naming_policy1.png', 'png', '2020-07-08 22:26:24');
INSERT INTO `t_qiniu_content` VALUES (248, 'yunke-oss', 'backend_listener_influxdb_graph', '20.67KB   ', '公开', 'http://yunke-oss.chachae.cn/backend_listener_influxdb_graph.png', 'png', '2020-07-08 22:26:24');
INSERT INTO `t_qiniu_content` VALUES (249, 'yunke-oss', '表2：开发类作品开发文档 蔡阅', '2.49MB   ', '公开', 'http://yunke-oss.chachae.cn/表2：开发类作品开发文档 蔡阅.pdf', 'pdf', '2020-07-08 22:31:20');
...
-- Records of t_role
-- ----------------------------
INSERT INTO `t_role` VALUES (1, '管理员', '管理员', '2017-12-27 16:23:11', '2020-07-16 15:20:49');
...
INSERT INTO `t_role` VALUES (8, '任务负责人', '可对任务和成员进行修改', '2020-07-16 15:20:17', NULL);
...
INSERT INTO `t_role_menu` VALUES (8, 220);
INSERT INTO `t_role_menu` VALUES (8, 222);
...
CREATE TABLE `t_school_assets`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '学校资产ID',
  `inclusion_date` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '收录日期',
  `assets_name` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '资产名称',
  `assets_num` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '资产编号',
  `price` double(10, 2) NULL DEFAULT NULL COMMENT '资产价格',
  `scrap_date` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '报废日期',
  `scrap_detail` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '报废信息',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学校资产表\r\n' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_school_assets_repair`  (
  `id` int(11) NOT NULL COMMENT '维修信息ID',
  `repair_date` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '维修日期',
  `assets_name` int(11) NULL DEFAULT NULL COMMENT '学校资产ID',
  `repair_price` double(10, 2) NULL DEFAULT NULL COMMENT '维修价格',
  `repair_invoice` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '发票',
  `repair_prover_user_info_uuid` int(11) NOT NULL COMMENT '维修证明人【userIndoUuid】',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `repair_school_prover`(`repair_prover_user_info_uuid`) USING BTREE,
  INDEX `学校资产ID`(`assets_name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '维修信息表\r\n' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_thesis`  (
  ...
  `introduction` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '摘要',
  `paper_type` int(11) NULL DEFAULT NULL COMMENT '论文类型(1核心/ 2普通）',
  `time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '论文下载',
  `cost` double(10, 2) NULL DEFAULT NULL COMMENT '花费',
  `state` int(11) NULL DEFAULT NULL COMMENT '状态（1进行中/2已完成）',
  `invoice` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '发票',
  `reimbursement` int(11) NULL DEFAULT NULL COMMENT '是否已报销（0否/1是）',
  PRIMARY KEY (`thesis_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '论文_任务表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_user`  (
  ...
  `full_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '真实姓名',
  `password` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '密码',
  `dept_id` bigint(20) NULL DEFAULT NULL COMMENT '部门ID',
  `email` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮箱',
  `mobile` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系电话',
  `status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '状态 1老师/2毕业生/3在校4考核/0禁用',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  ...
  `note_id` bigint(20) NULL DEFAULT NULL COMMENT '用户备注（1：教师，2：毕业，3：在校，4：考核）',
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, '201704044', '陈岳欣', '$2a$10$eG9uK3ujGwqWZCIXRCZgPOv0Rmh9KiDxNCf/rzz.MvATAh9uhZZ6e', 1, 'chachae@qq.com', '13670459539', '1', '2019-06-14 20:39:22', '2020-06-14 12:16:15', '2020-07-08 21:06:56', '0', '1', 'white', 'c7c4ee7be3eb4e73a19887dc713505145.jpg', '我是作者。', 1);
